...
ber_1 = open[5] > close[5] and open[4] > close[4] and open[3] > close[3] and open[2] < close[2] and open[1] > close[1] and high[3] >= close[2] and close[5] > close[2]
           
                                               
bull_2 = open[6] < close[6] and open[5] < close[5] and open[4] < close[4] and open[3] > close[3] and open[2] > close[2] and open[1] < close[1] and low[4] <= close[2] and close[6] < close[2]
ber_2 = open[6] > close[6] and open[5] > close[5] and open[4] > close[4] and open[3] < close[3] and open[2] < close[2] and open[1] > close[1] and high[4] >= close[2] and close[6] > close[2]
...
plot_shape(bull_2 , 'S_2', shape_style.arrowup, shape_size.large, 'transparent', shape_location.belowbar, 0, "S_2", call_color)
plot_shape(ber_2, 'xS_2', shape_style.arrowdown, shape_size.large, 'transparent', shape_location.abovebar, 0, "S_2", put_color)
